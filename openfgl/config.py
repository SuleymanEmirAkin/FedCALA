...
supported_scenario = ["graph_fl", ]

supported_graph_fl_datasets = ["MUTAG", "BZR", "COX2", "ENZYMES", "DD", "PROTEINS", "COLLAB",  "IMDB-BINARY", "IMDB-MULTI"]
...
parser.add_argument("--scenario", type=str, default="graph_fl", choices=supported_scenario)
...
# simulation settings
parser.add_argument("--simulation_mode", type=str, default="graph_fl_label_skew", choices=supported_graph_fl_simulations)
...
# task settings
parser.add_argument("--task", type=str, default="graph_cls", choices=supported_graph_fl_task)
